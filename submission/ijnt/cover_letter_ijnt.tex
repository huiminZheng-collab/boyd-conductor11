...
\url{zhhm@ahstu.edu.cn}), which we submit for consideration in the
\emph{International Journal of Number Theory}.
...
The paper is a natural fit for IJNT: one of its central references,
the work of Lal\'in and Ramamonjisoa on the Mahler measure of a
Weierstrass form --- whose conventions our conductor-17 appendix
adopts --- appeared in Int.\ J.\ Number Theory \textbf{13} (2017),
and the journal has an established readership for Mahler measure and
elliptic-curve $L$-value identities.
